...
public class ListaNombres {
    ...
    private final ArrayList<String> listadenombres; // Lista de arrays llamada listaDeNombres, contendrá los nombres
    ...
    public ListaNombres(String nombre) {
        ...
        listadenombres = new ArrayList<>(); // Creamos una nueva lista vacía
    }
